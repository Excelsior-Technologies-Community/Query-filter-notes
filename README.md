# Query & Filter Notes - MERN Stack Project
...
## 🎯 Overview
Query & Filter Notes is a simple MERN stack application that demonstrates how to:
- Set up a Node.js backend with Express
- Connect to MongoDB using Mongoose
- Configure environment variables securely
- Create a React frontend to manage notes
- Implement advanced querying and filtering for notes
...
✅ **Advanced Filtering** - Filter notes by category  
...
│   ├── controllers/
│   │   └── noteController.js  # Note CRUD operations and queries
│   ├── middleware/
...
│   │   ├── pages/
│   │   │   ├── AllNotesPage.jsx  # Page for viewing all notes
...
## 📸 Screenshots
1. **Home Page** - View and filter all notes
![Query-filter-notes/screenshots/image1.png](screenshots/image1.png)
1. **All Notes Page** - View and filter all notes
![Query-filter-notes/screenshots/image2.png](screenshots/image2.png)
2. **Create Note Page** - Form for adding new notes
![Query-filter-notes/screenshots/image.png](screenshots/image3.png)
...
- Implements advanced querying with filters, search, sort, pagination
...
**Pages**
- AllNotesPage: Main page with filters and note list
